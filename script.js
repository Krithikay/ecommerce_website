/* MiniStore — Frontend-only demo
   Features:
   - Product data stored in an array (can be extended)
   - Category filtering, search, sorting
   - Product quick view modal & detail view
   - Cart persisted in localStorage with add/update/remove
   - Simple register/login (mock, stored in localStorage)
   - Checkout placeholder that saves an order to localStorage
   - Export CSV / Print links
*/

/* ---------- Data (sample products) ---------- */
/* Images: either place images in /assets and use those filenames,
   or replace img property with remote URLs. */
const PRODUCTS = [
  { id: 1, title: "Wireless Headphones", category: "electronics", price: 59.99, rating:4.3, desc: "Comfortable over-ear headphones with long battery life.", img: "assets/p1.jpg" },
  { id: 2, title: "Classic Tee", category: "clothing", price: 19.99, rating:4.1, desc: "Soft cotton tee available in multiple sizes.", img: "assets/p2.jpg" },
  { id: 3, title: "Ceramic Mug", category: "home", price: 12.5, rating:4.7, desc: "Dishwasher-safe ceramic mug, 350ml.", img: "assets/p3.jpg" },
  { id: 4, title: "Leather Wallet", category: "accessories", price: 34.0, rating:4.5, desc: "Hand-stitched minimalist wallet.", img: "assets/p4.jpg" },
  { id: 5, title: "Bestseller Novel", category: "books", price: 9.99, rating:4.8, desc: "An engaging page-turner for weekend reading.", img: "assets/p5.jpg" },
  { id: 6, title: "Denim Jacket", category: "clothing", price: 79.0, rating:4.2, desc: "Classic denim jacket with a modern fit.", img: "assets/p6.jpg" },
